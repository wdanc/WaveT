"""
The original Training script from timm, Ross Wightman (https://github.com/rwightman)
"""

import sys
sys.path.append('/code/wavet')
import argparse
import time
import yaml
import os
...
from see.feature_similarity import pear_measure_in_train, eliminate_measure_in_train, overlap_measure_in_train
...
def main():
    ...
    train_set = torchvision.datasets.CIFAR100(root=args.data, train=True, download=True)
    # train_set = torchvision.datasets.CIFAR10(root=args.data, train=True, download=True)
    ...
    test_set = torchvision.datasets.CIFAR100(root=args.data, train=False, download=True)
    # test_set = torchvision.datasets.CIFAR10(root=args.data, train=False, download=True)
